  ...
  return (
    <div className="container mx-auto max-w-4xl p-4 md:p-6 space-y-6">
        <Card className="overflow-hidden shadow-lg">
            <div className="bg-gradient-to-r from-primary via-primary-dark to-primary-end p-6 text-primary-foreground relative">
                ...
                <Button asChild variant="outline" size="icon" className="absolute top-4 right-4 bg-white/20 border-white/30 text-white hover:bg-white/30 rounded-full">
