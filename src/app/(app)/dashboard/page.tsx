...
const StatCard = ({
  ...
  return (
    <Link href={href} className="block group">
      <Card className="bg-muted/50 hover:bg-muted/80 transition-colors h-full overflow-hidden aspect-[4/3] rounded-lg">
...
const ActionCard = ({
  ...
  return (
    <Link href={href} className="block group">
      <Card className="bg-muted/50 hover:bg-muted/80 transition-colors h-full overflow-hidden aspect-[3/4] rounded-lg">
        <div className="relative w-full h-full">
          {/* Image Slider Background */}
          {loading ? (
             <Skeleton className="absolute inset-0" />
